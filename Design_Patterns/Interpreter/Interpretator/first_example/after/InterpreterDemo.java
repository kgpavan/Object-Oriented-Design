package com.sourcemaking.interpretator.first_example.after;

import java.util.*;

/**
 * This is a refactoring that follows the intent of the Interpreter
 * design pattern. All classes in the  Operand hierarchy: implement
 * the evaluate(context), digest some piece of the context argument,
 * and return their contribution to the recursive traversal. Applying
 * the Interpreter pattern in this domain is probably inappropriate.
 */
